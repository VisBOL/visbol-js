...
function createGeometry(boxSize) {
    ...
    var topRight = Vec2(boxSize.x, boxSize.y * 0.9);
        
    //coordinate of pick
    var rightMostPick = Vec2(boxSize.x * 0.88, boxSize.y * 0.7);
    var right = Vec2(boxSize.x * 0.7, boxSize.y * 0.9);
    var middlePick = Vec2(boxSize.x * 0.5, boxSize.y * 0.7);
    var middle = Vec2(boxSize.x * 0.3, boxSize.y * 0.9);
    var leftMostPick = Vec2(boxSize.x * 0.1, boxSize.y * 0.7);
