...
Design.prototype = {
    ...
    redraw: function redraw() {
        ...
        this.components = this.displayList.components.map(function(componentObject) {
            ...
            var component = Component.render(design, componentObject, design.displayList.interactions.length);
        ...
        */
        ...
        this.interactions = this.displayList.interactions.map(function(interactionObject) {
           ...
           var interaction = Interaction.render(design, interactionObject, interactionIndex++);
