...
var Segment = require('./segment'),
    ...
    Simulation = require('./interactions/simulation'),
...
function renderInteraction(design, interaction) {
    ...
    if (interaction.SBO === "SBO:0000169") {
      ...
      Inhibition.render(design, interaction, segments); 
    }

    else if (interaction.SBO === "SBO:0000589") {
       
      Production.render(design, interaction, segments); 
       
    }
  
    else if (interaction.SBO === "SBO:0000170") {
      
      Simulation.render(design, interaction, segments);       
       
    }

    else if (interaction.SBO === "SBO:0000177") {
      
      nonCovelantBinding.render(design, interaction, segments); 
       
    }
  
     else if (interaction.SBO === "SBO:0000179") {
      
      Degradation.render(design, interaction, segments); 
    }
