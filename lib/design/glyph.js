...
const GlyphSelector = require('../rendering/react/glyphSVG/GlyphSelector');
/**
...
class Glyph {
    ...
    placeSelfAndHooks(display, type) {
        if (type === 'react') {
            const glyph = GlyphSelector[this.type];
            this.dimensions = glyph.dimensions;
            this.rendering = glyph.glyph;
