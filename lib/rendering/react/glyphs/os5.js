...
<svg  version="1.1"
    ...
    <path
        id="overhang_site-path1" 
        parametric:d="M{baseline_x+pad_before+(width*0.4)},{(baseline_y-baseline_offset)+(height*0.5)} L{baseline_x+pad_before+width},{(baseline_y-baseline_offset)+(height*0.5)}" 
        d="M8.0,27.5 L17,27.5" 
        fill="none"
        stroke="black"
        stroke-width="1pt"
        stroke-linejoin="round"
