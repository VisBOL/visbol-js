...
const complexType = {
  ...
  "protein_protein_complex": "protein_protein_complex",
  "molecule_protein_complex": "molecule_protein_complex",
  "rna_protein_complex": "rna_protein_complex",
  "SBGN": "complex"
};
...
function getComplexType(interaction){
   ...
   let reactant = undefined;
    ...
    /*
     *  we know that one of the reactants is always one we just need to find the other one
    ...
    */ 
    if (reactant.type === undefined) {
       ...
       return "protein_protein_complex";
    }
    else if (reactant.type === "SmallMolecule") {

       return "molecule_protein_complex";
    }
    else if (reactant.type === "Rna") {

       return "rna_protein_complex";
    }
