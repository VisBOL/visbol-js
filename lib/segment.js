...
>>>>>>> 1444d0d... Add better comments and fix the layout for non-covelant-binding
    var glyphs = segment.sequence.map(function(glyphObject) {
        ...
        */
        ...
        if (segment.role === "inhibitor") {
           ...
           var inhibitorProps = Arrows.InhibitorArrow.render(design, glyphObject, boundingBoxSize );
        ...
        if (segment.role === "product") {
           ...
           var productProps = Arrows.ProductArrow.render(design, glyphObject, boundingBoxSize );
        ...
        if (segment.role === "simulator") {
           ...
           var simulatorProps = Arrows.SimulatorArrow.render(design, glyphObject, boundingBoxSize );
