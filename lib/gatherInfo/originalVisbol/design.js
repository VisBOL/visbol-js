...
function Design(opts) {
    ...
    this.geom = {
        ...
        /*
        *this field is added so that after renderComponent can store its component box height in it
        */
        componentBoxHeight: cellSize,

        /*
        *this is the height of component svg group without adding the padding
        */
        componentHeight:cellSize,

        /*
        *this is the postion of interaction segment in view page,
        *it's going to get updated after each render interaction call
        */
        interactionPosition: 0,

        /*
        *this is the verticall space between interaction segments
        */
        interactionPadding: cellSize * 9,

        /*
        * this is the default height for interaction segment
        * we need to have this for determining how much more space we need to be able to
        * expand component box after rendering component
        */
        defaultInteractionHeight: cellSize * 13,

        /*
        *this is the offset of the DNA part in the circuit participating in the interaction
        */
        participantOffset: 0
    };
...
Design.prototype = {
    ...
    redraw: function redraw() {
        ...
        //need to remove interactions every time SBOl editor is updated
        ...
        */
        ...
        this.size = Vec2(Math.max(Rect.width(bbox) + 32, interactionGroup.bbox().width + 32), (Rect.height(bbox) + 32) + (interactionGroup.bbox().height + 32) + 32);
