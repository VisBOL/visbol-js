...
function DisplayList(displayListObject) {
    ...
    if(displayListObject.components !== undefined) {
       ...
       /* if(displayListObject.interactions !== undefined) {
          displayListObject.interactions = displayListObject.interactions.map(function(interaction) {

            //return DisplayList.Interaction(displayList, interaction);
            if (interaction.type === "inhibition") {

              for (let i in interaction.participants) {

                //find the DNA part in the interaction
   ...
   displayListObject.components.push(interaction.participants[1].segment)     
  }*/
...
/*
* right now it only works for interactions of type inhibition and production
*/
/*DisplayList.Interaction = function Interaction(displayList, interaction) {
  ...
  if (interaction.type === "genetic-production") {
